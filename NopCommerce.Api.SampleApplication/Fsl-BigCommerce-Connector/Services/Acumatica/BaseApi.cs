...
namespace Fsl.BigCommerce.Api.Connector.Services.Acumatica
{
    ...
    public abstract class BaseApi : IApiAccessor
    {
        ...
        protected string ComposeContentHeaders(HeaderContentType contentTypes)
        {
            ...
            return Configuration.ApiClient.SelectHeaderContentType(localVarHttpContentTypes);
        }
        ...
        protected object ComposeBody(object objectForRequestBody)
        {
            ...
            {
                postBody = Configuration.ApiClient.Serialize(objectForRequestBody); // http body (model) parameter
            }
            else
            {
        ...
        protected ApiResponse<T> DeserializeResponse<T>(IRestResponse response)
        {
            ...
            return new ApiResponse<T>(localVarStatusCode,
                ...
                (T)Configuration.ApiClient.Deserialize(response, typeof(T)));
        }
