...
namespace Fsl.BigCommerce.Api.Connector.Services.Acumatica
{
        ...
        where EntityType : Entity
    {
        ...
        /// <returns>Task of void</returns>
        public async Task InvokeActionAsync(EntityAction<EntityType> action)
        {
        ...
        /// <param name="custom">The fields that are not defined in the contract of the endpoint to be returned from the system. (optional)</param>
        /// <returns>Task of Entity</returns>
        public async Task<EntityType> GetByKeysAsync(List<string> ids, string select = null, string filter = null, string expand = null, string custom = null)
        {
        ...
        /// <param name="ids">The values of the key fields of the record.</param>
        /// <returns>Task of void</returns>
        public async Task DeleteByKeysAsync(List<string> ids)
        {
        ...
        protected async Task<ApiResponse<object>> PutFileAsyncWithHttpInfo(List<string> ids, string filename, byte[] content)
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
                ThrowMissingParameter("PutFile", nameof(ids));
        ...
        /// <param name="action">The record to which the action should be applied and the parameters of the action.</param>
        /// <returns>Task of ApiResponse</returns>
        protected async Task<ApiResponse<object>> InvokeActionAsyncWithHttpInfo(EntityAction<EntityType> action)
        {
            // verify the required parameter 'action' is set
            if (action == null)
                ThrowMissingParameter("InvokeAction", nameof(action));
        ...
        protected async Task<ApiResponse<EntityType>> PutEntityAsyncWithHttpInfo(EntityType entity, string select = null, string filter = null, string expand = null, string custom = null, PutMethod method = PutMethod.Any)
        {
        ...
        protected List<KeyValuePair<string, string>> ComposeQueryParams(string select = null, string filter = null, string expand = null, string custom = null, int? skip = null, int? top = null)
        {
            ...
            if (!string.IsNullOrEmpty(select)) queryParameters.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "$select", select)); // query parameter
            if (!string.IsNullOrEmpty(filter)) queryParameters.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "$filter", filter)); // query parameter
            if (!string.IsNullOrEmpty(expand)) queryParameters.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "$expand", expand)); // query parameter
            if (!string.IsNullOrEmpty(custom)) queryParameters.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "$custom", custom)); // query parameter
            if (skip != null) queryParameters.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "$skip", skip)); // query parameter
            if (top != null) queryParameters.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "$top", top)); // query parameter
        ...
        /// <param name="custom">The fields that are not defined in the contract of the endpoint to be returned from the system. (optional)</param>
        /// <returns>Task of ApiResponse (Entity)</returns>
        protected async Task<ApiResponse<EntityType>> GetByKeysAsyncWithHttpInfo(List<string> ids, string select = null, string filter = null, string expand = null, string custom = null)
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
        ...
        protected async Task<ApiResponse<List<EntityType>>> GetListAsyncWithHttpInfo(string select = null, string filter = null, string expand = null, string custom = null, int? _skip = null, int? _top = null)
        {
            var localVarPath = "/" + GetEntityName();
        ...
        /// <param name="ids">The values of the key fields of the record.</param>
        /// <returns>Task of ApiResponse</returns>
        protected async Task<ApiResponse<object>> DeleteByKeysAsyncWithHttpInfo(List<string> ids)
        {
            // verify the required parameter 'ids' is set
            if (ids == null)
        ...
        /// <param name="id">The session ID of the record.</param>
        /// <returns>Task of ApiResponse</returns>
        protected async Task<ApiResponse<object>> DeleteByIdAsyncWithHttpInfo(Guid? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        protected Dictionary<string, string> ComposeIDsPathParams(List<string> ids, string filename = null)
        {
            ...
            if (filename != null) pathParams.Add("filename", Configuration.ApiClient.ParameterToString(filename)); // path parameter
            return pathParams;
        }
    }
}
