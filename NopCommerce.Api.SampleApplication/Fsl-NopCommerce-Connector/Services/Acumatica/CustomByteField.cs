...
namespace Fsl.NopCommerce.Api.Connector.Services.Acumatica
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomByteField : CustomField, IEquatable<CustomByteField>, IValidatableObject
    {
        /// <summary>
        ...
        public CustomByteField(int? value = default, string type = default) : base(type)
        {
            Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomByteField {\n");
        ...
        {
            return Equals(input as CustomByteField);
        }
