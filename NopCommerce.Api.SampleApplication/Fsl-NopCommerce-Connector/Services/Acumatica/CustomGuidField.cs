...
namespace Fsl.NopCommerce.Api.Connector.Services.Acumatica
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomGuidField : CustomField, IEquatable<CustomGuidField>, IValidatableObject
    {
        /// <summary>
        ...
        public CustomGuidField(Guid? value = default, string type = default) : base(type)
        {
            Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomGuidField {\n");
        ...
        {
            return Equals(input as CustomGuidField);
        }
